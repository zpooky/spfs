...
# mount: /home/spooky/development/repos/spfs/test/mnt: wrong fs type, bad option, bad superblock on /dev/loop0, missing codepage or helper program, or other error.
